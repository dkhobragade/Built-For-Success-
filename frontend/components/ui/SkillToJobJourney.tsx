                    ...
                    <AnimatedCard direction="left" >
                        <Box >
                            ...
                            <Box padding={ 5 } display="flex" flexDirection="column" gap={ 5 } height="fit-content" bgcolor={ colors.WhiteSmoke } >
                                ...
                                <BlackButton variant="outlined" text="Start Practicing" />
                            </Box>
                        </Box>
                    </AnimatedCard>
                </Grid>
                    ...
                    <AnimatedCard direction="bottom" >
                        <Box >
                            <Box padding={ 5 } display="flex" flexDirection="column" gap={ 3.5 } height="fit-content" bgcolor={ colors.WhiteSmoke } >
                                ...
                                <BlackButton variant="outlined" text="Learn System Design" />
                            </Box>
                            <Box width="100%" height={ 250 } >
                    ...
                    <AnimatedCard direction="right" >
                        <Box >
                            ...
                            <Box padding={ 5 } display="flex" flexDirection="column" gap={ 5 } height="fit-content" bgcolor={ colors.WhiteSmoke } >
                                ...
                                <BlackButton variant="outlined" text="Start Learning Now" />
                            </Box>
                        </Box>
                    </AnimatedCard>
                </Grid>
